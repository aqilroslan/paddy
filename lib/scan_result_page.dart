...
import 'main_navigation.dart'; // <-- Change this import if your MainNavigation is elsewhere
...
class ScanResultPage extends StatelessWidget {
  ...
  Future<void> _saveResultToFirestore(BuildContext context) async {
    ...
    // Navigate to main navigation, index 3 (History)
    Navigator.pushAndRemoveUntil(
      context,
      MaterialPageRoute(builder: (_) => MainNavigation(startIndex: 3)),
          (route) => false,
    );
  }
              ...
              child: ListView(
                ...
                children: [
                  Padding(
                    ...
                    child: Text(
                      "Scan date: ${today.day}/${today.month}/${today.year}",
                      style: TextStyle(
                  ...
                  // Save button only if not unknown
                  if (!isUnknown)
                    SizedBox(
                      width: double.infinity,
                      child: ElevatedButton.icon(
                        ...
                        label: const Text("Save this scan result"),
